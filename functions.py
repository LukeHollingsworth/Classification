...
class Rosenbrock(ScalarFunction):
    ...
    def jacobian(self, x):
        ...
        derivative[0, 0] = 400*(x1**3) - 400*x1*x2 + 2*x1 - 2
        derivative[1, 0] = 200*x2 - 200*(x1**2)
    ...
    def hessian(self, x):
        ...
        second_derivative[0, 0] = 1200*(x1**2) - 400*x2 + 2
...
class LogisticRegressionNLL(ScalarFunction):
    ...
    def jacobian(self, phi):
        ...
        derivative = (probability - self.y) @ self.x.T
        derivative = np.reshape(derivative, (3,1))
